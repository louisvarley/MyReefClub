				...
				<div class="product-details">
					...
					<div class="product-meta">
						<ul class="list-inline">
							<li class="list-inline-item"><i class="fa fa-user-o"></i> By <a href=""><?php e($this->listing->name) ?></a></li>
							<li class="list-inline-item"><i class="fa fa-folder-open-o"></i> Category<a href=""><?php e($this->listing->type) ?></a></li>
							<li class="list-inline-item"><i class="fa fa-location-arrow"></i> Location<a href=""><?php e($this->listing->location) ?></a></li>
						</ul>
					</div>
					...
					<div class="content">
						...
						<div class="tab-content" id="pills-tabContent">
							<div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
								...
								<iframe src="https://www.youtube.com/embed/LUH7njvhydE?rel=0&amp;controls=0&amp;showinfo=0" allowfullscreen="" width="100%" height="400" frameborder="0"></iframe>
								<p></p>
